    ...
    return ( 
        <div className='container p-3'>
            <div className='row p-5'>
                ...
                <div className='col-6 p-5'>
                    <img src='me\media\image/ecosystem.png' style={{width:"100%"}}/>
                    <div className='text-center'>
                    
                        <a href='' className='mx-5' style={{textDecoration:"none"}}>Explain our Products <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
